...
import com.faysal.androidmvvmp3.databinding.NetworkStateItemBinding


class CatLoadingStateAdapter(private val retry: () -> Unit) :
    LoadStateAdapter<CatLoadingStateAdapter.LoadStateViewHolder>() {
